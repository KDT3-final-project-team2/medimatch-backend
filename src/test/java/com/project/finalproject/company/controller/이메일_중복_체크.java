//package com.project.finalproject.company.controller;//package com.project.finalproject.applicant.controller;
//
...
//        given(companyService.checkEmail(any(CompanySignupReqDTO.class)))
//                .willReturn("success"); // given : Mock 객체가 특정 상황에서 해야하는 행위를 정의하는 메소드.
//
//        MvcResult mvcResult = mockMvc.perform(post("/company/checkemail")
//                        .with(csrf())
